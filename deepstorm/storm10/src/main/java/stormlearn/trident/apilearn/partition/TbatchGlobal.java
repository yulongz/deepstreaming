 ...
 * File Name:TbatchGlobal.java 
 * Package Name:stormlearn.trident.apilearn.partition 
 * Date:2017年8月6日下午2:16:16 
 * Author:hadoop 
...
/**
 * ClassName:TbatchGlobal <br/>
 * Function: TODO ADD FUNCTION. <br/>
 * Reason: TODO ADD REASON. <br/>
 * Date: 2017年8月6日 下午2:16:16 <br/>
 * 
 * @author hadoop
 * @version
 * @see
...
public class TbatchGlobal {
	...
	public static StormTopology getStormTopology() {
		...
		Stream streambolt = streamSpout.batchGlobal().map(new PrintFields(true)).parallelismHint(3);

 ...
 * File Name:TslidingWindow.java 
 * Package Name:stormlearn.trident.apilearn.window 
 * Date:2017年8月8日下午4:06:22 
 * Author:hadoop 
...
/**
 * ClassName:TslidingWindow <br/>
 * Function: TODO ADD FUNCTION. <br/>
 * Reason: TODO ADD REASON. <br/>
 * Date: 2017年8月8日 下午4:06:22 <br/>
 * 
 * @author hadoop
 * @version
 * @see
...
public class TslidingWindow {
	...
	public static StormTopology getStormTopology() {
		...
		Stream streambolt = streamspout
				.slidingWindow(new BaseWindowedBolt.Duration(5000, TimeUnit.MILLISECONDS),
						new BaseWindowedBolt.Duration(2000, TimeUnit.MILLISECONDS), 

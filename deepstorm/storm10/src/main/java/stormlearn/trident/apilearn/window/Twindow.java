...
/**
 * ClassName:Twindow <br/>
 * Function: TODO ADD FUNCTION. <br/>
 * Reason: TODO ADD REASON. <br/>
 * Date: 2017年8月8日 下午4:01:53 <br/>
 * 
 * @author hadoop
 * @version
 * @see
...
public class Twindow {
	...
	public static StormTopology getStormTopology() {
		...
		// streambolt
		TumblingDurationWindow windowConfig = TumblingDurationWindow
				.of(new BaseWindowedBolt.Duration(5000, TimeUnit.MILLISECONDS));
		Stream streambolt = streamspout.window(windowConfig, 

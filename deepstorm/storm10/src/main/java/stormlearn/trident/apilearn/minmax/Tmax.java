...
public class Tmax {
	...
	public static StormTopology getStormTopology() {
		...
		topology.newStream("spout", spout).max(new MyMaxComparator()).each(new Fields("sentence"), new Debug());
	...
	static class MyMaxComparator implements Comparator<TridentTuple>, Serializable {

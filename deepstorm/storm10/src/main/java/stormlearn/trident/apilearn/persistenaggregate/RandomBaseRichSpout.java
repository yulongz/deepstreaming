...
public class RandomBaseRichSpout extends BaseRichSpout {
	...
	private static final Integer[] msgs = new Integer[] { 0, 1, 2, 3 };
	...
	public void nextTuple() {
		Utils.sleep(1000);
		Integer sentence = msgs[random.nextInt(4)];
		// 如果使用local
		...
		if (isDebug) {
			PrintHelper.print("componentId:" + _componentId + ",taskId:" + this._taskId + ",[" + msgId + "] " + sentence+".");
		}
	}

...
/**
 * ClassName:Tshuffle <br/>
 * Function: TODO ADD FUNCTION. <br/>
 * Reason: TODO ADD REASON. <br/>
 * Date: 2017年8月6日 下午2:12:28 <br/>
 * 
 * @author hadoop
 * @version
 * @see
...
public class TlocalOrShuffle {
	...
	public static StormTopology getStormTopology() {
		...
		Stream streambolt1 = streamSpout.shuffle().map(new PrintFields(true)).parallelismHint(2);
		Stream streambolt2 = streambolt1.localOrShuffle().map(new PrintFields(true)).parallelismHint(3);

 ...
 * <ul>
 *     <li>Start H2 database TCP server using {@link com.yulongz.ignite.utils.DbH2ServerStartup}.</li>
 *     <li>Start a few nodes using {@link com.yulongz.ignite.utils.ExampleNodeStartup}.</li>
 *     <li>Start example using {@link CacheJdbcStoreExample}.</li>
 * </ul>
 * <p>
 * Remote nodes can be started with {@link com.yulongz.ignite.utils.ExampleNodeStartup} in another JVM which will
...
//                    lsnr.setDataSource(JdbcConnectionPool.create("jdbc:h2:tcp://localhost/mem:ExampleDb", "sa", ""));
                    ...
                    dataSource.setURL("jdbc:mysql://127.0.0.1:3306/ignitedb");

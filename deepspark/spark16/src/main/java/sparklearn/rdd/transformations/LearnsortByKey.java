 ...
 * File Name:LearnsortByKey.java 
 * Package Name:sparklearn.rdd.transformations 
 * Date:2017年7月3日下午9:51:24 
 * sky.zyl@hotmail.com
*/
...
/**
 * ClassName:LearnsortByKey <br/>
 * Function: TODO ADD FUNCTION. <br/>
 * Reason: TODO ADD REASON. <br/>
 * Date: 2017年7月3日 下午9:51:24 <br/>
 * 
 * @author hadoop
 * @version
 * @see
 */
public class LearnsortByKey {

	public static void main(String[] args) {
		SparkConf conf = new SparkConf().setAppName("LearnsortByKey").setMaster("local");
		...
		JavaPairRDD<String, Integer> sortByKeyRDD = jPRDD.sortByKey(true);

		PrintUtilPro.printList(sortByKeyRDD.collect());

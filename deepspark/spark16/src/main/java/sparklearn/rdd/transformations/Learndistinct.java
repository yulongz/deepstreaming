 ...
 * File Name:Learndistinct.java 
 * Package Name:sparklearn.rdd.transformations 
 * Date:2017年7月3日下午9:48:14 
 * sky.zyl@hotmail.com
*/  
...
/** 
 * ClassName:Learndistinct <br/> 
 * Function: TODO ADD FUNCTION. <br/> 
 * Reason:   TODO ADD REASON. <br/> 
 * Date:     2017年7月3日 下午9:48:14 <br/> 
 * @author   hadoop 
 * @version   
 * @see       
 */
public class Learndistinct {
	...
	public static void main(String[] args) {
		SparkConf conf = new SparkConf().setAppName("Learndistinct").setMaster("local");
		...
		JavaRDD<String> jrdistinct = jRDD.distinct();
		 
		PrintUtilPro.printList(jrdistinct.collect());
	}

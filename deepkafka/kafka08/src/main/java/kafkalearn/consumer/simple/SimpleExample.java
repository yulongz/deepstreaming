 ...
 * File Name:SimpleExample.java 
 * Package Name:com.test.groups 
 * Date:2017年8月17日上午11:43:32 
 * Author:hadoop 
 * Email:sky.zyl@hotmail.com
*/

package kafkalearn.consumer.simple;

/** 
 * ClassName:SimpleExample <br/> 
 * Function: TODO ADD FUNCTION. <br/> 
 * Reason:   TODO ADD REASON. <br/> 
 * Date:     2017年8月17日 上午11:43:32 <br/> 
 * @author   hadoop 
 * @version   
 * @see       
 */
...
public class SimpleExample {
	...
	public static void main(String args[]) {
		...
		long maxReads = Long.parseLong(args[0]);//	Maximum number of messages to read (so we don’t loop forever)
		String topic = args[1];//	Topic to read from
		int partition = Integer.parseInt(args[2]);//	Partition to read from
		List<String> seeds = new ArrayList<String>();
		seeds.add(args[3]);//	One broker to use for Metadata lookup
		int port = Integer.parseInt(args[4]);//	Port the brokers listen on 
		try {
	...
	public void run(long a_maxReads, String a_topic, int a_partition, List<String> a_seedBrokers, int a_port)
		...
		while (a_maxReads > 0) {
			...
			// Note: this fetchSize of 100000 might need to be increased if large batches are written to Kafkas

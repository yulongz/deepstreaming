...
package kafkastreams.dsl.window.hopping;
...
public class Khoppingcount {
	...
	public static void main(String[] args) throws Exception {
		...
		// hopping
		KTable<Windowed<String>, Long> count = source.groupByKey().count(TimeWindows.of(TimeUnit.SECONDS.toMillis(6))
				.advanceBy(TimeUnit.SECONDS.toMillis(3)).until(TimeUnit.DAYS.toMillis(1)), "statestore");
		// [0,3)[0,6)[3,9)[6,12)[9,15)[12,18),如果只有历史数据的话，只会在[0,3)[0,6)中输出两次

...
package kafkastreams.dsl.api.branch;
...
public class Kbranch {
	...
	public static void main(String[] args) throws Exception {
		...
		// Jre8
//		KStream<String, String>[] sourcebranch = source.branch(
...
//		);
		...
		// Jre7
		 KStream<String, String>[] sourcebranch = source.branch(new
		...
		for (KStream<String, String> branch : sourcebranch) {
			branch.print();
		}

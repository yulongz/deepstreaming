...
package kafkastreams.dsl.api.filter;
...
public class Kfilter {
	...
	public static void main(String[] args) throws Exception {
		...
		// Jre8
		// KStream<String, String> sourcefilter = source.filter(
		// (key, value) -> value.startsWith("A")
		// );

		// Jre7
		KStream<String, String> sourcefilter = source.filter(new Predicate<String, String>() {

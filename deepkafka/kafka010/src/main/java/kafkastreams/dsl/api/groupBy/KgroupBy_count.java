...
package kafkastreams.dsl.api.groupBy;
...
public class KgroupBy_count {
	...
	public static void main(String[] args) throws Exception {
		...
		// jre8
		// KGroupedStream<String, String> groupBy = source.groupBy((key,value)-> value);
		...
		KTable<String, Long> count = groupBy.count("statestore");

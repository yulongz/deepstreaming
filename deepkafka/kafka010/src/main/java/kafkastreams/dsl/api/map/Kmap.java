...
package kafkastreams.dsl.api.map;
...
public class Kmap {
	...
	public static void main(String[] args) throws Exception {
		...
		// Jre8
//		KStream<String, String> map = source
//				.map((key, value) -> KeyValue.pair(value.toLowerCase(), Integer.toString(value.length())));

		// Jre7
		KStream<String, String> map = source.map(new KeyValueMapper<String, String, KeyValue<String, String>>() {
			@Override
			public KeyValue<String, String> apply(String key, String value) {
				return new KeyValue<>(value.toLowerCase(), Integer.toString(value.length()));
			}
		});
		map.print();

...
package kafkastreams.dsl.api.selectkey;
...
public class KselectKey {
	...
	public static void main(String[] args) throws Exception {
		...
		// Jre8
		// KStream<String, String> selectKey = source.selectKey((key, value) -> value);

		// Jre7
		KStream<String, String> selectKey = source.selectKey(new KeyValueMapper<String,String,String>(){
			@Override

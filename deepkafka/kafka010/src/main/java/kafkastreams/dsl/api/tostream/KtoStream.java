...
package kafkastreams.dsl.api.tostream;
...
public class KtoStream {
	...
	public static void main(String[] args) throws Exception {
		...
		String storeName = applicationId + "-Ktable";
		KTable<String, String> source = builder.table(Serdes.String(), Serdes.String(), inputTopic, storeName);
		KStream<String, String> toStream = source.toStream();
		toStream.print();

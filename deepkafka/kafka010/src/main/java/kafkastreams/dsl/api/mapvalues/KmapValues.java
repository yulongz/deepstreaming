...
package kafkastreams.dsl.api.mapvalues;
...
public class KmapValues {
	...
	public static void main(String[] args) throws Exception {
		...
		// Jre8
		// KStream<String, String> mapvalues = source.mapValues(value ->
		// value.toLowerCase());

		// Jre7
		KStream<String, String> mapvalues = source.mapValues(new ValueMapper<String, String>() {
			@Override

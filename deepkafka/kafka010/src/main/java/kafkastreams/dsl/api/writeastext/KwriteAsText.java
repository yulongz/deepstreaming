 ...
 * File Name:Kbranch.java 
 * Package Name:kafkastreams.dsl.api.branch 
 * Date:2017年8月24日上午9:50:54 
 * Author:hadoop 
 * Email:sky.zyl@hotmail.com
*/

package kafkastreams.dsl.api.writeastext;
...
public class KwriteAsText {
	...
	public static void main(String[] args) throws Exception {
		...
		source.writeAsText("src/main/java/kafkastreams/dsl/api/writeastext/data.txt");;

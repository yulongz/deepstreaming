...
package kafkastreams.dsl.api.filternot;
...
public class KfilterNot {
	...
	public static void main(String[] args) throws Exception {
		...
		// Jre8
		// KStream<String, String> sourcefilter = source.filterNot(
		// (key, value) -> value.startsWith("A")
		// );

		// Jre7
		KStream<String, String> sourcefilter = source.filterNot(new Predicate<String, String>() {

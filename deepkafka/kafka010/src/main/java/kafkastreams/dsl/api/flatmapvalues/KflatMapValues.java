...
package kafkastreams.dsl.api.flatmapvalues;
...
public class KflatMapValues {
	...
	public static void main(String[] args) throws Exception {
		...
		// Jre8
//		KStream<String, String> flatMapValues = source.flatMapValues(value -> {
...
//		});
		...
		// Jre7
		// KStream<String, String> flatMapValues = source.flatMapValues(new
		...
		// }
		// });
		KStream<String, String> flatMapValues = source.flatMapValues(new MyvalueMapper());
		flatMapValues.print();
...
// implements class
class MyvalueMapper implements ValueMapper<String, Iterable<String>> {
	@Override
	public Iterable<String> apply(String value) {
		List<String> result = new ArrayList<>(2);
		result.add(value.toUpperCase());
